    ...
    <div className="space-y-8">
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className={`h-10 w-10 rounded-lg ${chartCards[0].iconBg} flex items-center justify-center`}>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {chartCards.slice(1).map((card, index) => (
          <Card key={index} className="border border-slate-100 dark:border-slate-800 shadow-sm bg-white dark:bg-slate-900">
            <CardHeader>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
