...
export default function SendEmailPage() {
  ...
  const users: User[] = (usersResponse?.data as User[] | undefined) || [];
  ...
  const getSelectedUserDetails = (): User[] => {
    return users.filter((user: User) => selectedUsers.includes(user._id));
  };
              ...
              <CardContent className="space-y-4">
                    ...
                    {selectedUsers.length > 0 && (
                      <div className="space-y-2">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {getSelectedUserDetails().map((user: User) => (
                            <div
                              key={user._id}
                            ...
                            <div className="py-2">
                              {users.map((user: User) => (
                                <button
                                  key={user._id}
                                  onClick={() =>
                                    handleUserSelect(user._id, user.email)
                                  }
                ...
                <Button
                  ...
                  disabled={
                    ...
                    (recipientType === "multiple" &&
                      selectedUsers.length === 0) ||
                    (recipientType === "faculty" && !selectedFaculty) ||
                    (recipientType === "email" &&
                    ...
                    <div className="text-center p-4 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800">
                      <div className="text-2xl font-bold text-red-600 dark:text-red-400">
                        {result.emailResults.failed +
                          result.notificationResults.failed}
                      </div>
